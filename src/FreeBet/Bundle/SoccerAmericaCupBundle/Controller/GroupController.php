...
namespace FreeBet\Bundle\SoccerAmericaCupBundle\Controller;
...
class GroupController extends Controller
{
    ...
    public function matchListAction($events, $type, $name)
    {
        ...
        return $this->render('FreeBetSoccerAmericaCupBundle:Group:matchList.html.twig', array(
            'events' => $events,
            'type' => $type,
            'name' => $name
        ));
    ...
    public function resultAction($events, $group)
    {
        ...
        return $this->render('FreeBetSoccerAmericaCupBundle:Group:result.html.twig', array(
            'results' => $results,
            'group' => $group
        ));
    }
